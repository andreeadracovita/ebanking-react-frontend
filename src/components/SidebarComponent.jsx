...
export default function SidebarComponent() {
    ...
    return (
        <nav className="col-sm-2 bg-royal-blue sidebar Sidebar">
            <div className="sidebar">
                <ul className="nav flex-column">
                    <li className="nav-item text-white ms-3 mt-4 mb-4">
                            ...
                            <span className="ms-3 fw-bold">Welcome, {customerName}</span>
                    </li>
