            ...
            <div className="row pb-2 mb-3">
                <div className="col bg-light me-5 pt-2 pb-2">
                    ...
                    </div>
                    {
                        accounts.map(
                            account => (
                                <div className="container" key={account.iban}>
                ...
                <div className="col bg-light pt-2 pb-2">
                    ...
                    </div>
                    {
                        credits.map(
                            credit => (
                                <div className="container" key={credit.iban}>
                                    {credit.name.toString()}
                                    {credit.iban.toString()}
                                    {credit.balance()}
                                    {credit.currency.toString()}
                                </div>
                            )
                        )
                    }
            ...
            <div className="row pb-2 mb-3">
                <div className="col bg-light me-5 pt-2 pb-2">
                    ...
                    </div>
                    {
                        savings.map(
                            saving => (
                                <div className="container" key={saving.iban}>
                                    {saving.name.toString()}
                                    {saving.iban.toString()}
                                    {saving.balance()}
                ...
                <div className="col bg-light pt-2 pb-2">
                    ...
                    </div>
                    {
                        cards.map(
                            card => (
                                <div className="container" key={card.iban}>
                                    {card.name.toString()}
